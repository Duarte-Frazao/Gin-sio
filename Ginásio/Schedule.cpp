...
bool Schedule::listTaskbyDesc() const{
	...
	std::set<Task *,Task::TaskPtrCmpDesc>::iterator it_start = scheduleDesc.begin();
	std::set<Task *,Task::TaskPtrCmpDesc>::iterator it_end = scheduleDesc.end();
	std::set<Task *,Task::TaskPtrCmpDesc>::iterator it_last = it_end; it_last--;
